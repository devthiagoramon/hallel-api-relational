...
public class MinistryExcpetionHandler {
    ...
    public ResponseEntity<ExceptionResponse> handleFunctionMinistyrNotFound(FunctionMinistryNotFound exception,
                                                                            WebRequest request) {
        ExceptionResponse exceptionResponse = new ExceptionResponse(exception.getMessage(), new Date(),
                request.getDescription(false));
        return new ResponseEntity<>(exceptionResponse, HttpStatus.NOT_FOUND);
    ...
    public ResponseEntity<ExceptionResponse> memberAuditionMinistryNotFound(MemberAuditionMinistryNotFound exception,
                                                                            WebRequest request) {
        ExceptionResponse exceptionResponse = new ExceptionResponse(exception.getMessage(), new Date(),
                request.getDescription(false));
        return new ResponseEntity<>(exceptionResponse, HttpStatus.NOT_FOUND);
